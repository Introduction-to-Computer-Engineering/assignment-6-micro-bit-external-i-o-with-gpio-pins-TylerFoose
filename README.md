...
### Description
This program takes a reading of soil moisture and outputs a numerical value on the display. This also turns off the sensor when a reading is not being taken. 
